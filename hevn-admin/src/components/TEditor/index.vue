...
const tiny: any = reactive({
  ...
  init: {
    ...
    file_picker_callback: function (callback: any, value: any, meta: any) {
      ...
      inputElem.click();
      inputElem.onchange = () => {
        let file: any = inputElem.files[0]; //获取文件信息
        ...
        reader.onload = function () {
          ...
          let id: any = "blobid" + new Date().getTime();
          let blobCache: any = tinymce.activeEditor.editorUpload.blobCache;
          let base64: any = reader.result.split(",")[1];
          let blobInfo: any = blobCache.create(id, file, base64);
